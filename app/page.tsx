    ...
    <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
      <div className="mt-[5%] inline-block max-w-xxl text-center justify-center">
        ...
        <h3 className="text-Uni mt-2">
          Computer Science Master @ NOVA School of Science and Technology
        </h3>
      </div>
        ...
        <div className="mt-6">
          <div className="flex items-center gap-4 text-lg">
            ...
            <p className="text-description leading-snug">
              I am a Master&apos;s degree student in Computer Science at NOVA
              School of Science and Technology. I am passionate about technology
              and software development. I am always looking for new challenges
              and opportunities to learn and grow.
            </p>
          </div>
          <div className="flex items-center gap-4 text-lg mt-8">
            <p className="text-description leading-snug">
              I compleated my Bachelor&apos;s degree in Computer Science at
              Universidade Autónoma de Lisboa. In addition to my academic
              background, I have experience in software development, web
              development, and data analysis. Notably, worked as a software
          ...
          <div className="flex items-center gap-4 text-lg mt-8">
            ...
            />
            <p className="text-description leading-snug">
              Besides my academic and professional background, I love spending
              time with my friends mainly playing video games. I am a huge fan
              of Dota 2. I also enjoy listening to music mostly City-Pop and
              Hip-Hop. Check out my Spotify playlist!
            </p>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        style={{ minBlockSize: "500px" }}
      >
        <h1 className="text-About font-bold mt-8 mb-8">Certifications</h1>
