...
export const ResumeIcon: React.FC<IconSvgProps> = ({
    ...
    return (
        <svg
            ...
            {...props}>
            <path
                d='M9 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6H9zm4 1.5L18.5 9H13V3.5z'
                fill='currentColor'
            />

            <path
                d='M12 12c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm-2 2c-1.11 0-2 .89-2 2v1h8v-1c0-1.11-.89-2-2-2h-4z'
                fill='currentColor'
            />
        </svg>
    );
...
export const LinkedInIcon: React.FC<IconSvgProps> = ({
    ...
    return (
        <svg
           ...
           2.239 5 5 5h14c2.761 0 5-2.239 5-5V5c0-2.761 
           -2.239-5-5-5ZM7.154 19H3.154V9h4v10ZM5.154 
           7.551a2.318 2.318 0 1 1 0-4.636 2.318 
           2.318 0 0 1 0 4.636ZM20.077 19h-4v-5.403c0-1.289
           -.025-2.946-1.797-2.946-1.799 0-2.075 1.406
           -2.075 2.86V19h-4V9h3.846v1.373h.055c.538-.99 
           1.852-2.037 3.808-2.037 4.073 0 4.825 2.676 
           4.825 6.146V19Z'
                fill='currentColor'
            />
        </svg>
